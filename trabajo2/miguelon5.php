...
<div class="contener" style="font-family: 'Unbounded', sans-serif; background-color: #000000;">
  <a class="navbar-brand" href="/trabajo2/miguelonorigen.html" style="color: #eef0f2; font-size: 21px; font-family: 'katakana tfb', sans-serif;">Inicio</a>
   ...
   <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="nav navbar-nav" style="font-family: 'Vazirmatn', sans-serif; background-color: none; font-size: 18px;">
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="/trabajo2/miguelonorigen.html" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: #eef0f2; font-family: 'katakana tfb', sans-serif;">Unidad 1</a>
            <!-- Lo que sigue son los menus que se van a desplegar hacia abajo, cada uno tendra el nombre de su practica, ejemplo, practica uno se llamara su nombre el numero de la practica ZZ terminando con HTML -->
             <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <a class="dropdown-item" href="/trabajo2/miguelon1.php">Mostrar Datos 1</a><br>
                <a class="dropdown-item" href="/trabajo2/miguelon2.php">Mostrar Datos 2</a><br>
                <a class="dropdown-item" href="/trabajo2/miguelon3.php">Mostrar Datos 3</a><br>
             </div>
        </li>
        <li class="nav-item dropdown">
            ...
            <!-- Lo que sigue son los menus que se van a desplegar hacia abajo, cada uno tendra el nombre de su practica, ejemplo, practica uno se llamara su nombre el numero de la practica ZZ terminando con HTML -->
             <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <a class="dropdown-item" href="/trabajo2/miguelon4.php">Practica 4</a><br>
                <a class="dropdown-item" href="/trabajo2/miguelon5.php">Practica 5</a><br>
        ...
        <li class="nav-item dropdown">
            ...
            <!-- Lo que sigue son los menus que se van a desplegar hacia abajo, cada uno tendra el nombre de su practica, ejemplo, practica uno se llamara su nombre el numero de la practica ZZ terminando con HTML -->
             <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <a href="dropdown-item" href="/Migueln.html">Practica 7</a><br>
                <a href="dropdown-item" href="/Miguelon.html">Practica 8</a><br>
